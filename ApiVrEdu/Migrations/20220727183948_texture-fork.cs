...
{
    /// <inheritdoc />
    public partial class texturefork : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    DisplacementScale = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    Color = table.Column<Color>(type: "jsonb", nullable: false),
                    RoughnessMap = table.Column<string>(type: "text", nullable: true),
                    Map = table.Column<string>(type: "text", nullable: true),
                    NormalMap = table.Column<string>(type: "text", nullable: true),
                    DisplacementMap = table.Column<string>(type: "text", nullable: true),
                    AoMap = table.Column<string>(type: "text", nullable: true),
                    MetalnessMap = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Textures_Textures_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitySymbol = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsActivated = table.Column<bool>(type: "boolean", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TypeEffects_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MassNumber = table.Column<int>(type: "integer", nullable: true),
                    AtomicNumber = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsConstraint = table.Column<bool>(type: "boolean", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    TypeEffectId = table.Column<int>(type: "integer", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsActivated = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipments_TypeEffects_TypeEffectId",
                        column: x => x.TypeEffectId,
                        principalTable: "TypeEffects",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextureId = table.Column<int>(type: "integer", nullable: true),
                    TypeEffectId = table.Column<int>(type: "integer", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsActivated = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Effects_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Effects_Textures_TextureId",
                        column: x => x.TextureId,
                        principalTable: "Textures",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Effects_TypeEffects_TypeEffectId",
                        column: x => x.TypeEffectId,
                        principalTable: "TypeEffects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Effects_ProductId",
                table: "Effects",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Effects_TextureId",
                table: "Effects",
                column: "TextureId");

            migrationBuilder.CreateIndex(
                name: "IX_Effects_TypeEffectId",
                table: "Effects",
                column: "TypeEffectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipments_TypeEffectId",
                table: "Equipments",
                column: "TypeEffectId");
